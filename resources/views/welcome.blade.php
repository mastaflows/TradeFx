    ...
    <div class="uk-container">
        <div class="uk-grid" data-uk-grid="">
            ...
            <div class="uk-position-center">
                <img src="img/in-lazy.svg" data-src="front/in-slideshow-image-1.png" alt="slideshow-image" width="862" height="540" data-uk-img="">
            </div>
        </div>
    </div>
</li> <li>
        ...
        <div class="uk-grid" data-uk-grid="">
            <div class="uk-width-1-2@m">
                <div class="uk-overlay">
                    ...
                    <div class="in-slideshow-button">
                        <a href="#" class="uk-button uk-button-primary uk-border-rounded">Open account</a>
                        <a href="#" class="uk-button uk-button-default uk-border-rounded uk-margin-small-left uk-visible@m">Discover covesting</a>
                    </div>
                    <p class="uk-text-small"><span class="uk-text-primary">*</span>Trading in Forex/ CFDs is highly speculative and carries a high level of risk.</p>
                </div>
            </div>
            <div class="uk-position-center">
                <img src="img/in-lazy.svg" data-src="front/in-slideshow-image-2.png" alt="slideshow-image" width="862" height="540" data-uk-img="">
            </div>
        </div>
    </div>
</li>
                ...
                <div class="uk-child-width-1-2@s uk-child-width-1-2@m" data-uk-grid="">
                    <div class="uk-flex uk-flex-middle">
                        <div class="uk-margin-right">
                            <img src="img/in-lazy.svg" data-src="front/in-profit-icon-1.svg" alt="profit-icon" width="72" height="72" data-uk-img="">
                        </div>
                        <div>
                    ...
                    <div class="uk-flex uk-flex-middle">
                        <div class="uk-margin-right">
                            <img src="img/in-lazy.svg" data-src="front/in-profit-icon-2.svg" alt="profit-icon" width="72" height="72" data-uk-img="">
                        </div>
                        <div>
                    ...
                    <div class="uk-flex uk-flex-middle">
                        <div class="uk-margin-right">
                            <img src="img/in-lazy.svg" data-src="front/in-profit-icon-3.svg" alt="profit-icon" width="72" height="72" data-uk-img="">
                        </div>
                        <div>
                    ...
                    <div class="uk-flex uk-flex-middle">
                        <div class="uk-margin-right">
                            <img src="img/in-lazy.svg" data-src="front/in-profit-icon-4.svg" alt="profit-icon" width="72" height="72" data-uk-img="">
                        </div>
                        <div>
                ...
                <div class="uk-child-width-1-2@s uk-child-width-1-2@m uk-margin-medium-top" data-uk-grid="">
                        ...
                        <div class="in-pricing-1">
                            <div class="uk-card uk-card-default uk-box-shadow-medium">
                                <div class="uk-card-media-top">
                                    <img class="uk-width-1-1 uk-align-center" src="img/in-lazy.svg" data-src="front/in-profit-content-1.jpg" width="460" height="368" alt="sample-image" data-uk-img="">
                                  <span></span>
                                </div>
                    ...
                    <div>
                        <div class="in-pricing-1">
                            <div class="uk-card uk-card-default uk-box-shadow-medium">
                                <div class="uk-card-media-top">
                                    <img class="uk-width-1-1 uk-align-center" src="img/in-lazy.svg" data-src="front/in-profit-content-2.jpg" width="460" height="368" alt="sample-image" data-uk-img="">
                                  <span></span>
                                </div>
                                <div class="uk-card-body">
                        ...
                        <div class="uk-card uk-card-default uk-card-body in-profit-appcard">
                            <div class="uk-child-width-1-2@m" data-uk-grid="">
                                ...
                                <div class="uk-visible@m">
                                    <img src="img/in-lazy.svg" data-src="front/in-profit-mockup-1.png" width="450" height="203" alt="profit-mockup" data-uk-img="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- section content end -->
<!-- section content begin -->
<div class="uk-section uk-section-secondary uk-padding-large uk-background-contain uk-background-bottom-center in-padding-large-vertical@s in-profit-10" data-src="front/bg.png" data-uk-img="">
            ...
            <div class="uk-width-1-1">
                <div class="uk-child-width-1-2@s uk-child-width-1-5@m in-profit-stockprice" data-uk-grid="">
                    <div>
                        <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                            <span class="uk-float-left">
                                <img src="img/in-lazy.svg" data-src="front/in-profit-ticker-1.svg" alt="profit-ticker" width="77" height="20" data-uk-img="">
                            </span>
                    ...
                    <div>
                        <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                            <span class="uk-float-left">
                                <img src="img/in-lazy.svg" data-src="front/in-profit-ticker-2.svg" alt="profit-ticker" width="77" height="20" data-uk-img="">
                            </span>
                            <span class="uk-float-right down">
                    ...
                    <div>
                        <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                            <span class="uk-float-left">
                                <img src="img/in-lazy.svg" data-src="front/in-profit-ticker-3.svg" alt="profit-ticker" width="77" height="20" data-uk-img="">
                            </span>
                            <span class="uk-float-right down">
                    ...
                    <div>
                        <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                            <span class="uk-float-left">
                                <img src="img/in-lazy.svg" data-src="front/in-profit-ticker-4.svg" alt="profit-ticker" width="77" height="20" data-uk-img="">
                            </span>
                    ...
                    <div class="uk-visible@m">
                        <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                            <span class="uk-float-left">
                                <img src="img/in-lazy.svg" data-src="front/in-profit-ticker-5.svg" alt="profit-ticker" width="77" height="20" data-uk-img="">
                            </span>
                            <span class="uk-float-right up">
